...
use AiSignalMarkdown\Inc\Markdown\Engine\WpHtmlApiMarkdownEngine;
/**
 * Markdown converter.
 */
class MarkdownConverter {
	...
	public function convert_post( $post ) {
		 ...
		 */
		return apply_filters( 'aisignal_markdown_output', $markdown, $post );
	}
	...
	protected function should_use_supplemental_fallback( string $markdown ) {
		...
		$threshold    = (int) apply_filters( 'aisignal_markdown_thin_word_threshold', 120 );
