...
use WpMarkdownConverter\Inc\Markdown\Engine\WpHtmlApiMarkdownEngine;
/**
 * Markdown converter.
 */
class MarkdownConverter {
	...
	public function convert_post( $post ) {
		 ...
		 */
		return apply_filters( 'wp_markdown_converter_output', $markdown, $post );
	}
	...
	protected function should_use_supplemental_fallback( string $markdown ) {
		...
		$threshold    = (int) apply_filters( 'wp_markdown_converter_thin_word_threshold', 120 );
