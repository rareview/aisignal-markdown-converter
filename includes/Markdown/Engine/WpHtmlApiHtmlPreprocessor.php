...
class WpHtmlApiHtmlPreprocessor {
	...
	public function prepare( string $html ): string {
		...
		$root = $dom->getElementById( 'wp-web-page-content-to-markdown-converter-root' );
	...
	private function load_fragment_dom( string $html ) {
		...
		$wrapped         = '<!DOCTYPE html><html><body><div id="wp-web-page-content-to-markdown-converter-root">' . $html . '</div></body></html>';
