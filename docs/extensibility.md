...
### `aisignal_markdown_discovery_enabled`
...
### `aisignal_markdown_response_headers`
...
### `aisignal_markdown_rest_response`
...
### `aisignal_markdown_availability`
...
### `aisignal_markdown_frontmatter_data`
...
### `aisignal_markdown_main_content_selectors`
...
### `aisignal_markdown_candidate_score`
...
### `aisignal_markdown_thin_word_threshold`
...
### `aisignal_markdown_homepage_output`
...
### `aisignal_markdown_crawler_patterns`

Filter the bot detection pattern registry.

### `aisignal_markdown_crawler_should_log`
...
### `aisignal_markdown_crawler_log_entry`
